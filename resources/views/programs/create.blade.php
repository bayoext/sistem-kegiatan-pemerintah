    ...
    <div class="max-w-4xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">
                {{ isset($program) ? 'Edit Program' : 'Buat Program Baru' }}
            </h1>
            <p class="text-gray-600 mt-2">
                {{ isset($program) ? 'Perbarui detail program Anda' : 'Isi detail untuk membuat program baru' }}
            </p>
        </div>
        ...
        <div class="card-primary">
            <form action="{{ isset($program) ? route('programs.update', $program) : route('programs.store') }}"
                ...
                <div class="space-y-6">
                    ...
                    <!-- Dates & Budget -->
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900 mb-4">Jadwal & Anggaran</h2>
                    ...
                    <!-- Location & Thumbnail -->
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900 mb-4">Detail Tambahan</h2>
                    ...
                    <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" class="btn-primary">
                            {{ isset($program) ? 'Perbarui Program' : 'Buat Program' }}
                        </button>
                    </div>
                </div>
            </form>
