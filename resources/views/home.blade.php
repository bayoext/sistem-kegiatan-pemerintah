...
<p class="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 lg:pt-28 lg:pb-24">
            <div class="text-center">
                ...
                <p class="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                    Platform digital terpadu untuk mengelola, memantau, dan melaporkan seluruh program dan kegiatan pemerintah dengan 
                    <span class="font-semibold text-gray-900">transparansi</span> dan 
                    <span class="font-semibold text-gray-900">akuntabilitas</span> penuh
                </p>
                
                <div class="flex flex-col sm:flex-row justify-center gap-4 mb-12">
                    <a href="{{ route('programs.public') }}" class="group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 inline-flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    ...
                    @guest
                    <a href="{{ route('register') }}" class="group bg-white text-gray-900 px-8 py-4 rounded-xl font-semibold hover:bg-gray-50 transition-all duration-300 inline-flex items-center justify-center border-2 border-gray-200 hover:border-gray-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <svg class="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
                    <div class="text-center p-4">
                        ...
                        <div class="text-sm text-gray-600 font-medium">Program Aktif</div>
                    </div>
                    <div class="text-center p-4">
                        <div class="text-2xl font-bold text-gray-900">{{ $stats['Berjalan_programs'] }}+</div>
                        <div class="text-sm text-gray-600 font-medium">Sedang Berjalan</div>
                    </div>
                    <div class="text-center p-4">
                    ...
                    <div class="text-center p-4">
                        ...
                        <div class="text-sm text-gray-600 font-medium">Transparan</div>
                    </div>
                </div>
            </div>
        </div>
