...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Buat Kategori Baru</h1>
            <p class="text-gray-600 mt-2">Tambahkan kategori baru untuk mengatur program Anda</p>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                                  class="w-full border-gray-300 rounded-lg focus:border-primary-500 focus:ring-primary-500">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
